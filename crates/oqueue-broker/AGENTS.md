...
2. **Generic over its seams, not hardwired to them.** The concrete `ObjectStore`, `Clock` and `KeyProvider` are chosen by `bin/oqueue`; this crate names none of them (NFR-51).
