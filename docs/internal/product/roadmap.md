...
|---|---|---|
| **Every row M5 closed over** — `M5.11`, `M5.81`, `M5.82`, `M5.83`, `M5.87`, `M5.89`, `M5.14`, `M5.15`, `M5.16`, `M5.17`, `M5.23`, `M5.24`, `M5.25`, `M5.26`, `M5.28`, `M5.29`, `M5.30`, `M5.31`, `M5.32`, `M5.33`, `M5.34`, `M5.35`, `M5.36`, `M5.37`, `M5.44`, `M5.45`, `M5.59`, `M5.66`, `M5.69`, `M5.68`, `M5.92` | M6 (from M5) | M5 closed on `m5-complete.sh` (FR-33 idle retention, FR-34, FR-35 under simulation) with these open. ⚠️ **Two carry requirements the M5 row above qualifies**: `M5.92` — nothing in the shipped broker compacts — and `M5.16`/`M5.17` — retention on a partition still being written, and by size. Handed on rather than reopened by the user's instruction that a milestone end against its written exit on a small number of tasks (`M5.93`); `milestone-review`'s reopen test would have kept both. The rest are gate and document work and compaction's remaining mechanisms (`M5.14`, `M5.15`, `M5.44`). `M6.md`'s *Received from M5* section receives them, and M6's opening commit re-derives each as its own row and marks this one `dissolved` |
