...
| M12 | FR-40 (the five group APIs M4 left unmet — task 3a's `GroupGrants`, a second grants type and so a contract change in `oqueue-core` with its own ADR and every fake in one commit, which is not something to invent at a completion gate), FR-44, FR-45, FR-50, FR-52, FR-53, NFR-12 |
