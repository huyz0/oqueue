...
| 4 | [M2](milestones/M2.md) | Kafka wire protocol: produce and fetch | functional | M0 | see `backlog.md` ⚠️ | `scripts/gates/m2-complete.sh` | in progress |
