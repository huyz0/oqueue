...
⚠️ **M-1 is over the 20-task limit** `sdd.md` now states, at 44. It accumulated
the planning work and the defects its own gates found. It is the evidence for
the rule, not an exception to it; every milestone after it is planned under the
cap and should be split rather than allowed to grow.
