...
10. `M3.37`, the sweep, last of the work rows — so it also catches the
   sentences the rows above falsify.
11. **`M3.16`**, which cannot assert its zero-GET and bounded-GET claims until
...
12. **`M3.17`** last, because a closing milestone review over unfinished rows
