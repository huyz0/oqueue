...
⚠️ **M0 carries 27 rows, over `sdd.md`'s cap of 20, and here is the argument the
...
five of its nine majors are arguments rather than rows. ⚠️ The forcing
