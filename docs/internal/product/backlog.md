...
*carry*: every one is `deferred` with `M2` receiving, none is scheduled for M1,
and M1 closes without doing any of them. What they are not is M2 *rows*,
