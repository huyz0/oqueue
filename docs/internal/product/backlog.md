...
⚠️ **M1 carries 35 rows, over `sdd.md`'s cap of 20, and here is the argument
...
| — | M1.33, M1.34 | no plan item: found by review after the decomposition was written — `M1.33` by the checkpoint review, `M1.34` by `M1.21` |
