...
4. Check [10-open-questions.md](10-open-questions.md) before assuming a design decision has been made — most haven't yet; this corpus is mostly background research, not a finalized architecture. **The exceptions are [15](15-scale-architecture-position.md)** (working position on scale architecture) **and [21](21-ai-development-loop.md)** (design position on the AI development loop); both are explicitly marked as positions rather than research, and both carry their own open questions.
